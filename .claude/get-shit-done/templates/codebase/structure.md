...
- Usage: Reference from command with `@D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/latuan/Programming/nautobot-mcp-cli/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/latuan/Programming/nautobot-mcp-cli/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
