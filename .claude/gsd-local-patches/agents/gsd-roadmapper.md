...
Reference full template: `D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/templates/state.md`.
