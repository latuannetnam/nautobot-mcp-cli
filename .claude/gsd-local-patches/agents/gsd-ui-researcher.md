...
Use template from `D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/latuan/Programming/nautobot-mcp-cli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
